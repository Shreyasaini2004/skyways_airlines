package com.skyways.notification.exception;

import com.skyways.notification.domain.ErrorLog;
import com.skyways.notification.dto.ErrorResponse;
import com.skyways.notification.dto.FieldErrorResponse;
import com.skyways.notification.repository.ErrorLogRepository;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotificationNotFound(NotificationNotFoundException ex, HttpServletRequest request) {
        return build(HttpStatus.NOT_FOUND, "NOTIFICATION_NOT_FOUND", ex, request);
    }
